        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h1 className="font-playfair text-8xl md:text-9xl lg:text-[12rem] font-bold leading-tight">
              ...
              <p className="text-3xl md:text-4xl text-muted-foreground max-w-lg leading-relaxed">
          ...
          <div className="hidden lg:block">
            <div className="text-center space-y-4">
              <div className="egyptian-gold text-9xl font-playfair font-bold">
                Loved by Melbourne
              </div>
              <div className="text-primary text-5xl font-playfair">
