        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h1 className="font-playfair text-6xl md:text-7xl lg:text-8xl font-bold leading-tight">
          ...
          <div className="hidden lg:block">
            <div className="text-center space-y-4">
              <div className="egyptian-gold text-7xl font-playfair font-bold">
                Loved by Melbourne
              </div>
              <div className="text-primary text-3xl font-playfair">
